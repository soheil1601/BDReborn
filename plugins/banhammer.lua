...
if is_banned(data.id_, arg.chat_id) then
   if not lang then
		...
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "کاربر "..user_name.." `[ "..data.id_.." ]` از گروه محروم است", 0, "md")
end
kick_user(data.id_, arg.chat_id)
end
if is_gbanned(data.id_) then
     if not lang then
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "⛔️ *User* "..user_name.." `[ "..data.id_.." ]` *is Globally banned*", 0, "md")
    else
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "کاربر "..user_name.." `[ "..data.id_.." ]` از تمام گروه های ربات محروم است", 0, "md")
   end
kick_user(data.id_, arg.chat_id)
     end
	end
...
user_name = check_markdown(data.first_name_)
  ...
  if not lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "⛔️ *You can't ban_ *mods,owners and bot admins*", 0, "md")
   else
...
if administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *is already Banned*", 0, "md")
   else
     return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` از گروه محروم بود", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] = user_name
   ...
   kick_user(data.id_, arg.chat_id)
    if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *has been Banned*", 0, "md")
    else
    return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` از گروه محروم شد", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *is not Banned*", 0, "md")
   else
    return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." *`["..data.id_.."]` از گروه محروم نبود", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)
   if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *has been unbanned*", 0, "md")
   else
    return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` از محرومیت گروه خارج شد", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
user_name = check_markdown(data.first_name_)
   ...
   if is_mod1(arg.chat_id, data.id_) then
  if not lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "⛔️ *You can't silent mods,owners and bot admins*", 0, "md")
    else
...
if administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
    if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *is already silent*", 0, "md")
  else
     return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` *از قبل توانایی چت کردن رو نداشت*", 0, "md")
     end
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = user_name
    save_data(_config.moderation.data, administration)
  if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *added to silent users list*", 0, "md")
  else
     return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` *توانایی چت کردن رو از دست داد*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
   if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *is not silent*", 0, "md")
   else
    return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` *از قبل توانایی چت کردن را داشت*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)
    if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *removed from silent users list*", 0, "md")
  else
     return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` *توانایی چت کردن رو به دست آورد*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if is_gbanned(data.id_) then
   if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *is already globally banned*", 0, "md")
    else
     return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` *از گروه های ربات محروم بود*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id_)] = user_name
   ...
   kick_user(data.id_, arg.chat_id)
     if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *has been globally banned*", 0, "md")
   else
     return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` *از تمام گروه های ربات محروم شد*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not is_gbanned(data.id_) then
   if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *is not globally banned*", 0, "md")
   else
     return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` *از گروه های ربات محروم نبود*", 0, "md")
      end
   end
  administration['gban_users'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)
    if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "*User* "..user_name.." `["..data.id_.."]` *has been globally unbanned*", 0, "md")
   else
     return tdcli.sendMessage(arg.chat_id, "", 0, "کاربر "..user_name.." `["..data.id_.."]` *از محرومیت گروه های ربات خارج شد*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
tdcli.deleteMessagesFromUser(data.chat_id_, data.sender_user_id_, dl_cb, nil)
   if not lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "*All messages of `[ "..data.sender_user_id_.." ]` *has been deleted*", 0, "md")
      elseif lang then
...
tdcli.deleteMessagesFromUser(arg.chat_id, data.id_, dl_cb, nil)
   if not lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "*All messages of* "..user_name.." `[ "..data.id_.." ]` *has been deleted*", 0, "md")
      elseif lang then
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   if not lang then
     tdcli.sendMessage(msg.to.id, "", 0, "*You can't kick mods,owners or bot admins*", 0, "md")
   elseif lang then
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if is_mod1(msg.to.id, userid) then
   if not lang then
   return tdcli.sendMessage(msg.to.id, "", 0, "*You can't delete messages mods,owners or bot admins*", 0, "md")
     elseif lang then
...
tdcli.deleteMessagesFromUser(msg.to.id, matches[2], dl_cb, nil)
    if not lang then
  return tdcli.sendMessage(msg.to.id, "", 0, "*All messages of* *[ "..matches[2].." ]* *has been deleted*", 0, "md")
   elseif lang then
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   if not lang then
    return tdcli.sendMessage(msg.to.id, "", 0, "*You can't globally ban other admins*", 0, "md")
else
   ...
   if not lang then
  return tdcli.sendMessage(msg.to.id, "", 0, "⛔️ *User* "..matches[2].." *is already globally banned*", 0, "md")
    else
...
kick_user(matches[2], msg.to.id)
   if not lang then
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "⛔️ *User* "..matches[2].." *has been globally banned*", 0, "md")
    else
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if not is_gbanned(matches[2]) then
     if not lang then
   return tdcli.sendMessage(msg.to.id, "", 0, "⛔️ *User* "..matches[2].." *is not globally banned*", 0, "md")
    else
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if is_mod1(msg.to.id, userid) then
     if not lang then
    return tdcli.sendMessage(msg.to.id, "", 0, "*You can't ban mods,owners or bot admins*", 0, "md")
    else
   ...
   if not lang then
  return tdcli.sendMessage(msg.to.id, "", 0, "*User* "..matches[2].." *is already banned*", 0, "md")
  else
...
kick_user(matches[2], msg.to.id)
   if not lang then
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "_User "..matches[2].." *has been banned*", 0, "md")
  else
 ...
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." توانایی چت کردن رو به دست آورد*", 0, "md")
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
     ...
     if not lang then
				return "*All banned* _users has been unbanned_"
    else
    ...
    if not lang then
      ...
      if not lang then
				return "*All globally banned* _users has been unbanned_"
   else
